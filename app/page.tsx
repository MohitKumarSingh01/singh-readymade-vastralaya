    ...
    <>
      ...
      <main>
        <section className="hero container">
          <div>
            <p className="eyebrow">SINGH READYMADE VASTRALAYA</p>
            ...
            <p className="hero-copy">
              Fashion for men, women and kids — from daily essentials to
              festive sarees and winter layers.
            </p>
          ...
          <div className="hero-card">
            ...
            <small>24 demo styles · ready to customize</small>
          </div>
        </section>
